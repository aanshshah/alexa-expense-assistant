...
/**
 * ExpenseAssistant is a child of AlexaSkill.
 * To read more about inheritance in JavaScript, see the link below.
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Introduction_to_Object-Oriented_JavaScript#Inheritance
 */
var ExpenseAssistant = function() {
    AlexaSkill.call(this, APP_ID);
};

// Extend AlexaSkill
ExpenseAssistant.prototype = Object.create(AlexaSkill.prototype);
ExpenseAssistant.prototype.constructor = ExpenseAssistant;

ExpenseAssistant.prototype.eventHandlers.onSessionStarted = function (sessionStartedRequest, session) {
    console.log("ExpenseAssistant onSessionStarted requestId: " + sessionStartedRequest.requestId
        + ", sessionId: " + session.sessionId);

    // any session init logic would go here
};

ExpenseAssistant.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    console.log("ExpenseAssistant onLaunch requestId: " + launchRequest.requestId + ", sessionId: " + session.sessionId);
    getWelcomeResponse(response);
};

ExpenseAssistant.prototype.eventHandlers.onSessionEnded = function (sessionEndedRequest, session) {
...
ExpenseAssistant.prototype.intentHandlers = {
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        var speechText = "With Expense Assistant, you can tell Alexa what you spent your money on and she will keep track of it.  " +
            "For example, you can say I spent ten dollars on a movie";
        var repromptText = "How much and where did you spend it?";
        var speechOutput = {
            speech: speechText,
...
function getWelcomeResponse(response) {
    ...
    var cardTitle = "Expense Assistant!";
    var repromptText = "With Expense Assistant, you can tell Alexa what you spent your money on and she will keep track of it. For example, you can say I spent ten dollars on a movie";
    var speechText = "<p>Expense Assistant.</p> <p>Where did you spend your money and how much?</p>";
    var cardOutput = "Expense Assistant. Where did you spend your money and how much?";
...
function handleFirstEventRequest(intent, session, response) {
    var expenseSlot = intent.slots.number;
    var output = '';
    var text = 0;
for (var property in expenseSlot) {
    text = expenseSlot[property];
    console.log('EXPENSE SLOT: ' + text);
}
    var repromptText = "With Expense Assistant, you can tell Alexa what you spent your money on and she will keep track of it. For example, you can say I spent ten dollars on a movie";
    ...
    var prefixContent = "<p>For " + text + ", </p>";
    // var prefixContent = "<p>For " + monthNames[date.getMonth()] + " " + date.getDate() + ", </p>";
    var cardContent = "For " + text + ", ";

    var cardTitle = "Money spent " + text;
    ...
    // getJsonEventsFromWikipedia(monthNames[date.getMonth()], date.getDate(), function (events) {
        ...
        // if (events.length == 0) {
            speechText = "Amount has been recorded!";
...
exports.handler = function (event, context) {
    // Create an instance of the ExpenseAssistant Skill.
    var skill = new ExpenseAssistant();
